                ...
                <div class="card-body">
                    <div class="bg-light p-3">
                        <form action="" method="POST">
                            @csrf
                            <div class="mb-3 row">
                                <label for="goods_code" class="col-sm-2 col-form-label">Kode<i class="text-red">*</i></label>
                                <div class="col-sm-10"><input type="text" class="form-control" id="goods_code" name="goods_code"></div>
                            </div>
                            <div class="mb-3 row">
                            ...
                            <div class="card-footer mt-4">
                                <button type="submit" class="btn btn-sm noborder btn-info mr-2">
                                    <i class="fas fa-plus-circle"></i> Ubah Data
                                </button>
